					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="description-container m-t-20">
                                @if(session()->get('language') == 'serbian') {{ $product->short_description_srb }} @else {{ $product->short_description_eng }} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">@if(session()->get('language') == 'serbian') 
                                            {!! $product->long_description_srb !!} @else {!! $product->long_description_eng !!} @endif</p>
...
@endphp			
	...
	<div class="reviews">
        ...
        <div class="row">
			<div class="col-md-3">
			<img style="border-radius: 50%" src="{{ (!empty($item->user->profile_photo_path))? url('upload/user_images/'.$item->user->profile_photo_path):url('upload\admin_images\No-Image-Placeholder.svg.png') }}" width="40px;" height="40px;"><b> {{ $item->user->name }}</b>
			</div>
...
@include('frontend.widgets.related_products')
