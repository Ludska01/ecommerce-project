...
<div class="body-content">
	...
	<h1>@if(session()->get('language') == 'serbian') {{ $blogpost->post_title_srb }} @else {{ $blogpost->post_title_en }} @endif</h1>
	...
	<p> @if(session()->get('language') == 'serbian') {!!  $blogpost->post_details_srb  !!} @else {!!  $blogpost->post_details_en  !!} @endif
	</p>
