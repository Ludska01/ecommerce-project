...
<div class="container-full">
	...
	<div class="form-group">
		...
		<div class="controls">
	 <input type="text" name="meta_title" class="form-control" value="{{ (isset($seo->meta_title))? $seo->meta_title :""}}" > </div>
	</div>
	...
	<div class="form-group">
		...
		<div class="controls">
	 <input type="text" name="meta_author" class="form-control"  value="{{ (isset($seo->meta_author))? $seo->meta_author :""}}"  > </div>
	</div>

	<div class="form-group">
		<h5>Meta Keyword <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text" name="meta_keyword" class="form-control" value="{{ (isset($seo->meta_keyword))? $seo->meta_keyword :""}}"   > </div>
	</div>
 ...
 <div class="form-group">
	...
	<textarea name="google_analytics" id="textarea" class="form-control" required placeholder="Textarea text">
		{{ (isset($seo->google_analytics))? $seo->google_analytics :""}}
	</textarea>     
	 		 </div>
		</div>
