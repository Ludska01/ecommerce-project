...
<div class="container-full">
 ...
 <input type="file" name="profile_photo_path" class="form-control" id="image"> </div>
				...
				<div class="col-md-6">
	<img id="showImage" src="{{ url('upload/admin_images/'.$adminuser->profile_photo_path) }}" style="width: 100px; height: 100px;">				
		...
		<div class="controls">
			...
			<fieldset>
				...
				<label for="checkbox_14">Reports</label>
                    ...
                    <input type="hidden" id="checkbox_15" name="alluser" value="1">
