...
<div class="row"> <!-- start 2nd row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Post Title Srb <span class="text-danger">*</span></h5>
			<div class="controls">
				<input type="text" name="post_title_srb" class="form-control" required="">
     @error('post_title_srb') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea id="editor1" name="post_details_en" class="form-control" rows="10" cols="80" required="">
		Post Details English
	     ...
	     <div class="form-group">
			<h5>Post Details Srb <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="post_details_srb" class="form-control" rows="10" cols="80">
		Post Details Srb
						</textarea>       
	 		 </div>
		</div>
