  ...
  <!-- Content Wrapper. Contains page content -->
	 ...
	 <tr>
		...
		<td>{{ $item->blog_category_name_en }}</td>
		 <td>{{ $item->blog_category_name_srb }}</td>
		<td>
...
<!--   ------------ Add Blog Category Page -------- -->
	...
	<div class="form-group">
		<h5>Blog Category srb <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text" name="blog_category_name_srb" class="form-control" >
     @error('blog_category_name_srb') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror 
	  </div>
	</div>
