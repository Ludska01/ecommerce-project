						...
						<div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="showImage"style="width:100px; height:100px;"  src="{{ (!empty($editData->profile_photo_path)) ? url('upload/admin_images/'.$editData->profile_photo_path) : url('upload\admin_images\No-Image-Placeholder.svg.png')}}" alt="User Avatar">
